			...
			{pagina4 ? (
				...
				<Slide direction="up" in={pagina5} mountOnEnter unmountOnExit>
					...
					<img src={voltar} className="voltar" height="30px" onClick={() => { setPagina3(true); setPagina5(false)}}/> 
						{!vou ? 						<p id="end" style={{ color: "white", fontFamily: "'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif" }}>Poxa, que pena!! 😢</p>
 : <p id="end" style={{ color: "white", fontFamily: "'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif" }}>Uhuu, te espero lá!! ❤️</p>}
					</div>
				</Slide>
			) : (
				''
